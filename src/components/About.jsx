        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 italic mb-6">
              ...
              learning technologies to empower students to achieve their career
              aspirations in medicine and engineering.
            </p>
            ...
            <p className="mb-2">
              <strong>Vision:</strong> To become the leading destination in
              South India for holistic and result-oriented coaching for NEET &
              JEE.
            </p>
            <p>
              <strong>Mission:</strong> To provide conceptual clarity,
              consistent practice, and emotional resilience to students through
              an integrated academic ecosystem.
            </p>
          </div>
        </div>
      </div>
